...
public:
    TrajectoryControlServer() : Node("trajectory_control_server", rclcpp::NodeOptions().automatically_declare_parameters_from_overrides(true)) 
    {
        ...
        // this->cartesian_trajectory_service_ = this->create_service<franka_control_services::srv::TrajectoryCartesian>("cartesian_trajectory_service", 
        // std::bind(&TrajectoryControlServer::callbackCartesianTrajectoryService, this, std::placeholders::_1, std::placeholders::_2));

        // this->cartesian_linear_trajectory_service_ = this->create_service<franka_control_services::srv::TrajectoryCartesian>("cartesian_linear_trajectory_service", 
        // std::bind(&TrajectoryControlServer::callbackCartesianLinearTrajectoryService, this, std::placeholders::_1, std::placeholders::_2));
        
        // this->joint_trajectory_service_ = this->create_service<franka_control_services::srv::TrajectoryJointSpace>("joint_trajectory_service", 
        // std::bind(&TrajectoryControlServer::callbackJointTrajectoryService, this, std::placeholders::_1, std::placeholders::_2));

        this->obstacle_add_service_ = this->create_service<franka_control_services::srv::ObstacleInsertion>("obstacle_add_service",
        std::bind(&TrajectoryControlServer::callbackObstacleAddService, this, std::placeholders::_1, std::placeholders::_2));

        // this->obstacle_del_service_  = this->create_service<franka_control_services::srv::ObstacleDeletion>("obstacle_del_service",
...
private:
    ...
    // Members
    // 
    rclcpp::Service<franka_control_services::srv::TrajectoryCartesian>::SharedPtr cartesian_trajectory_service_;
    rclcpp::Service<franka_control_services::srv::TrajectoryCartesian>::SharedPtr cartesian_linear_trajectory_service_;
    rclcpp::Service<franka_control_services::srv::TrajectoryJointSpace>::SharedPtr joint_trajectory_service_;
    std::vector<std::string> obstacles;
    rclcpp::Service<franka_control_services::srv::ObstacleInsertion>::SharedPtr obstacle_add_service_;
    rclcpp::Service<franka_control_services::srv::ObstacleDeletion>::SharedPtr obstacle_del_service_;
    // 
    // Methods
    // 
    /** 
